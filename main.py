...
from src.CNN_Classifier.pipeline.stage_01_data_ingesstion import DataIngestionTrainingPipeline
...
from src.CNN_Classifier.pipeline.stage_05_evaluation import EvaluationPipeline
